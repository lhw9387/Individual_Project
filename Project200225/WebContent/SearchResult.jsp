    ...
    <table>
    	<c:choose>
    		...
    		<c:otherwise>		
				...
				<td> <img src="PfileUpload/${product.pfile}" width="380" height="480" onclick="location.href='productView?pfile=${product.pfile}'"> <br> ${product.productname} <br> KRW ${product.price} </td>
