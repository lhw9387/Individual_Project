    ...
    function pwdCheck(){
    	...
    	function idCheck(){
    	    ...
    	    if(id.value.match(exp)){
    	        ...
    	        alo.innerHTML = "<b> 적합한 아이디입니다.</b> ";
    	        return true;
    	    } else {
    	        alo.style.color = "red";
    	        alo.innerHTML = "<b> 적합하지 않은 아이디입니다.</b> ";
    	        return false;
...
function topFunction() {
  ...
  document.documentElement.scrollTop = 0;
	...
	<form action="MemberJoin" method="post" enctype="multipart/form-data">
		<table>
			<tr>
				...
				<td>
					...
					id="idForm"
                	placeholder=" 아이디 영문 소문자/숫자 6~10자" 
                	maxlength="16"
                	onblur="checkReset1()">
                &nbsp;
                <span id= "alo"></span>
			...
			<tr>
				...
				<td colspan="3">
				 <input type="text" name="phone" id="phone" onkeyup="phoneCheck()" onblur="checkReset3()" placeholder=" 휴대폰 번호">
                &nbsp;
		...
		<button id=btn2 onclick = "onSubmit()"> 회원 가입 </button>
