...
function topFunction() {
  ...
  document.documentElement.scrollTop = 0;
	...
	<h2> - ORDER - </h2>
	<div id = "productinfo">
			<img id="myimage" src="PfileUpload/${order.pfile}" width="100" height="100"> 
			<form action="OrderBuy" method="post" enctype="multipart/form-data">
			<table id = "productinfotable">
			<tr>
				<td style="text-align:left">
				<input type = "hidden" name = "id" value="${member.id}">
				<input type = "hidden" name = "productno" value="${order.productno}">
				<input id = "producta" name = "productname" value="${order.productname}"></td>
			</tr>
			<tr>
				<td style="text-align:left">${order.category}</td>
			</tr>
			<tr>
				<td>KRW <input id = "producta" name = "price" value="${order.price}"></td>
			</tr>
			</table>
		</div>
	<br><br>
	<div id="orderdiv"> <p style="font-size:18px">배송 정보 </p></div>
	<table id = "ordertable">
			<tr id = "ordertr">
				<th id = "orderth">
					받으시는 분
				</th>
				<td colspan="3" id = "ordertd">
					<input type="text" class = "orderinput" name="name" value=" ${member.name}">
				</td>
			</tr>		
			<tr id = "ordertr">
				<th id = "orderth">
				...
				<td colspan="3" id = "ordertd">
					...
					<input type="text" class = "orderinput" name="postcode" id="sample6_postcode" placeholder=" 우편번호">&nbsp;
					<input type="button" class = "orderinput" id = "addressbtn" onclick="sample6_execDaumPostcode()" value=" 우편번호 찾기"><br><br>
					<input type="text" class = "orderinput" name="address2" id="sample6_address" placeholder=" 주소">&nbsp;
					<input type="text" class = "orderinput" name="detailAddress" id="sample6_detailAddress" placeholder=" 상세주소">&nbsp;
					<input type="text" class = "orderinput" name="extraAddress" id="sample6_extraAddress" placeholder=" 참고항목">
					</div>
				</td>
			</tr>
			<tr id = "ordertr">
				...
				<td colspan="3" id = "ordertd">
				 <input type="text" class = "orderinput" name="phone" id="phone" value=" ${member.phone}">
				</td>
			</tr>
			<tr id = "ordertr">
				<th id = "orderth">
				...
				<td colspan="3" id = "ordertd">
					<input type="email" class = "orderinput" name="email" value=" ${member.email}">
				</td>
			</tr>
		</table>
	<br><br>
		<button id = "btn2" onclick = "onSubmit()"> 구매하기 </button>
	</form>	
	<br><br><br><br>
	<div id = "footerdiv">
		<ul id = "footerul1">
