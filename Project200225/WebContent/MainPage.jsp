  ...
  document.documentElement.scrollTop = 0;
	...
	<div class="slideshow-container">
        ...
        <div class="mySlides fade">
            <img src="./PfileUpload/img1.JPG" onclick="location.href='productView?productno=19&page=1'" style="width:100%">
        </div>

        <div class="mySlides fade">
            <img src="./PfileUpload/img2.JPG" onclick="location.href='productView?productno=31&page=1'" style="width:100%">
        </div>

        <div class="mySlides fade">
            <img src="./PfileUpload/img3.JPG" onclick="location.href='productView?productno=30&page=1'" style="width:100%">
        </div>
    ...
    <br>
    <div class = "function">
    	<p class = "productcount">Total : </p>
    	<ul id = "type">
    		<li id = "typelist" onclick="location.href='ProductList'"> 신상품 </li>
    		<li id = "typelist" onclick="location.href='NameList'"> 상품명 </li>
    		<li id = "typelist" onclick="location.href='PriceAscList'"> 낮은가격 </li>
    		<li id = "typelist" onclick="location.href='PriceDescList'"> 높은가격 </li>
    	</ul> 
    </div>
    <br>
    <c:set var="i" value="0" />
	...
	<div id="paging">
		...
		<c:if test="${paging.page>1}">
			<a href="ProductList?page=${paging.page-1}">[이전]</a>&nbsp;
		</c:if>
		...
		<c:if test="${paging.page<paging.maxPage}">
			&nbsp;<a href="ProductList?page=${paging.page+1}">[다음]</a>
		</c:if>
	</div>
	<br><br>
	<div id = "footerdiv">
