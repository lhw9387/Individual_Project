  ...
  document.documentElement.scrollTop = 0;
	...
	<div class="slideshow-container">
        ...
        <div class="mySlides fade">
            <img src="./PfileUpload/img1.JPG" style="width:100%">
        </div>

        <div class="mySlides fade">
            <img src="./PfileUpload/img2.JPG" style="width:100%">
        </div>

        <div class="mySlides fade">
            <img src="./PfileUpload/img3.JPG" style="width:100%">
        </div>
	...
	<div id="paging">
		...
		<c:if test="${paging.page>1}">
			<a href="PriceDescList?page=${paging.page-1}">[이전]</a>&nbsp;
		</c:if>
		<c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="i"
			...
			<c:choose>
				...
				<c:otherwise>
					<a href="PriceDescList?page=${i}">${i}</a>
				</c:otherwise>
			</c:choose>
		</c:forEach>
		...
		<c:if test="${paging.page<paging.maxPage}">
			&nbsp;<a href="PriceDescList?page=${paging.page+1}">[다음]</a>
		</c:if>
	</div>
	<br><br>
<div id = "footerdiv">
