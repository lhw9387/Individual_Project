...
function topFunction() {
  ...
  document.documentElement.scrollTop = 0;
	...
	<br><br>
	<h1> 금액 충전 <i class="fas fa-coins"></i> </h1>
	<form action="CashCharge" method="post" enctype="multipart/form-data">
		<div id = "select">
		<select name = "cash" onChange="getSelectValue(this.form);">
			<option onselect="focus">금액 선택</option>
        ...
        <br><br>
        <button id=btn2 onclick = "onSubmit()"> 금액 충전 </button>
	</form>
	<br><br><br><br>
<div id = "footerdiv">
		<ul id = "footerul1">
