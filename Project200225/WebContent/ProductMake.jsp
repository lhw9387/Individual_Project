...
function topFunction() {
  ...
  document.documentElement.scrollTop = 0;
	...
	<h1> ADD </h1>
	<form action="ProductMake" method="post" enctype="multipart/form-data">
		<table>
			<tr>
				<th>
					상품명
				...
				<td>
					<input id = "joininput" type="text" name="productname" maxlength="16">
				</td>
				<td rowspan="3">
				<p style="text-align: center;">
					<img style="height:300px" src="./PfileUpload/다운로드.png" id="output"/>
				</p>
				</td>
			</tr>		
			<tr>
			...
			<tr>
				...
				<td>
					<input id = "joininput" type="text" name="price">
            	</td>
			</tr>
			<tr>
				<th>
				...
				<td colspan="2">
					<select name="size" onChange="getSelectValue(this.form);">
						<option onselect="focus">사이즈</option>
			...
			<tr>
    			...
    			<td colspan="2">
        			<input id = "joininput" name="pfile" type='file' accept="image/*" onchange="loadFile(event)">
    			</td>
			</tr>
		</table>
		<br>
		<button id=btn2 onclick = "onSubmit()"> 상품 추가 </button>
