...
public class NameListController extends HttpServlet {
    ...
    protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ProductDTO> productList = ProductPagingService.productNameList(startRow, endRow);
		...
		RequestDispatcher dispatch = request.getRequestDispatcher("NameListPage.jsp");
